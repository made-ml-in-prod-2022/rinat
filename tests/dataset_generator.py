...
def generate_dataset(n_rows: int):
    ...
    fake_data = {
        ...
        "restecg": fake.random_elements(elements=list(range(3)), length=n_rows),  # noqa: E501
        ...
        "condition": fake.random_elements(elements=list(range(2)), length=n_rows),  # noqa: E501
    }
